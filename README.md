...
> This a project about a relational database 

**[kayjeesql]** a relational database table to store animals' information, insert some data into it, and query it.
...
- GitHub: [@githubhandle](https://github.com/kayjee)
