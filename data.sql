...
-- UPDATE species_id col from animals table using species table
UPDATE animals SET species_id = 2 WHERE name LIKE '%mon';
UPDATE animals SET species_id = 1 WHERE species_id IS NULL;

-- UPDATE owner_id col from animals table using owners table
...
INSERT INTO visits (vet_id, animal_id, visit_date)
VALUES ((SELECT id FROM vets WHERE name = 'William Tatcher'), (SELECT id FROM animals WHERE name = 'Boarmon'), '2021-01-11');
